...
| [`@pylinka/core`](./packages/core) | Runtime: pools, uniform bus, scheduler, backends, render. Peer `pixi.js@^8`. | **partial (M1.3)** — CPU scheduler/knobs/timing shipped; WebGPU backend gated on the M1.0 spike |
