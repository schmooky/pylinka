...
export const RECIPES: Recipe[] = [
  ...
  vfx({ slug: 'tumbling-shards', title: 'Tumbling Shards', group: 'rotation', key: 'star_05',
    ...
    capacity: 600, mode: 'burst', burstCount: 60, burstInterval: 1.6, velMin: [-260, -320], velMax: [260, -60],
    lifeMin: 1.2, lifeMax: 2.2, gravity: [0, 420], drag: 0.3,
    startAngle: [0, 360], spin: [-540, 540],
    colorFrom: '#ffe9b0ff', colorTo: '#ff7a2a00', colorEase: 'sine.in', scaleFrom: 2.2, scaleTo: 1.2 }),
  fx({ slug: 'spinning-coins', title: 'Spinning Coins', group: 'rotation',
    ...
    capacity: 400, blend: 'normal', rate: 26, shape: 'rect', size: [420, 10],
    velMin: [-30, 60], velMax: [30, 190], lifeMin: 1.8, lifeMax: 3, gravity: [0, 220],
    startAngle: [0, 360], spin: [-160, 160],
    colorFrom: '#ffffffff', colorTo: '#ffffff00', colorEase: 'sine.in', scaleFrom: 1.6, scaleTo: 1.4, atlas: COINS }),
  vfx({ slug: 'quarter-turn-drop', title: 'Quarter-Turn Drop', group: 'rotation', key: 'twirl_01',
    oneLiner: 'Tiles fall and turn exactly 90 degrees, easing to a stop.', tags: ['rotation', 'ramp', 'ease'],
    capacity: 300, rate: 22, shape: 'rect', size: [380, 8], velMin: [-14, 30], velMax: [14, 90],
    lifeMin: 1.4, lifeMax: 2.2, gravity: [0, 140], drag: 0.4,
    rotate: [0, 90], rotateEase: 'power3.out',
    colorFrom: '#cfe4ffff', colorTo: '#5a8fff00', colorEase: 'sine.in', scaleFrom: 2.2, scaleTo: 1.6 }),
